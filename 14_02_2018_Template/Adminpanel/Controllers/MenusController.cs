...
namespace _14_02_2018_Template.Adminpanel.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,menu_name,menu_link,menu_title")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,menu_name,menu_link,menu_title")] Menu menu)
        {
            if (ModelState.IsValid)
            {
